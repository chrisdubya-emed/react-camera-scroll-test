...
import { BasicDepthPacking as BasicDepthPacking6, NoBlending as NoBlending11, PerspectiveCamera as PerspectiveCamera3, REVISION, ShaderMaterial as ShaderMaterial11, Uniform as Uniform11, Vector2 as Vector26 } from "three";
...
import { LinearFilter, sRGBEncoding, UnsignedByteType as UnsignedByteType2, WebGLRenderTarget } from "three";
...
var DepthCopyPass = class extends Pass {
  constructor({ depthPacking = RGBADepthPacking3 } = {}) {
    ...
    this.renderTarget = new WebGLRenderTarget5(1, 1, {
      type: depthPacking === RGBADepthPacking3 ? UnsignedByteType3 : FloatType2,
...
import { LinearFilter as LinearFilter2, sRGBEncoding as sRGBEncoding2, UnsignedByteType as UnsignedByteType5, WebGLRenderTarget as WebGLRenderTarget6 } from "three";
var kernelPresets = [
  ...
  initialize(renderer, alpha, frameBufferType) {
    if (frameBufferType !== void 0) {
      ...
      if (frameBufferType !== UnsignedByteType5) {
        ...
        this.renderTargetA.texture.encoding = sRGBEncoding2;
        this.renderTargetB.texture.encoding = sRGBEncoding2;
      }
    }
  }
  static get AUTO_SIZE() {
...
var EffectComposer = class {
  ...
  setRenderer(renderer) {
    ...
    if (renderer !== null) {
      ...
      if (frameBufferType === UnsignedByteType8 && renderer.outputEncoding === sRGBEncoding3) {
        this.inputBuffer.texture.encoding = sRGBEncoding3;
        this.outputBuffer.texture.encoding = sRGBEncoding3;
        this.inputBuffer.dispose();
        this.outputBuffer.dispose();
      }
  ...
  createBuffer(depthBuffer, stencilBuffer, type, multisampling) {
    ...
    if (type === UnsignedByteType8 && renderer !== null && renderer.outputEncoding === sRGBEncoding3) {
      renderTarget.texture.encoding = sRGBEncoding3;
    }
...
import { LinearFilter as LinearFilter5, sRGBEncoding as sRGBEncoding4, Uniform as Uniform19, WebGLRenderTarget as WebGLRenderTarget10 } from "three";
...
var BloomEffect = class extends Effect {
  ...
  initialize(renderer, alpha, frameBufferType) {
    ...
    if (frameBufferType !== void 0) {
      this.renderTarget.texture.type = frameBufferType;
      if (renderer.outputEncoding === sRGBEncoding4) {
        this.renderTarget.texture.encoding = sRGBEncoding4;
      }
    }
  }
};
...
import { BasicDepthPacking as BasicDepthPacking13, LinearFilter as LinearFilter6, sRGBEncoding as sRGBEncoding5, Uniform as Uniform24, UnsignedByteType as UnsignedByteType9, WebGLRenderTarget as WebGLRenderTarget11 } from "three";
  ...
  initialize(renderer, alpha, frameBufferType) {
    ...
    if (frameBufferType !== void 0) {
      ...
      if (renderer.outputEncoding === sRGBEncoding5) {
        ...
        this.renderTargetNear.texture.encoding = sRGBEncoding5;
        this.renderTargetFar.texture.encoding = sRGBEncoding5;
        this.renderTargetMasked.texture.encoding = sRGBEncoding5;
      }
    }
  }
};
...
var NoiseTexture = class extends DataTexture {
  constructor(width, height, format = LuminanceFormat, type = UnsignedByteType10) {
  ...
  initialize(renderer, alpha, frameBufferType) {
    ...
    if (frameBufferType !== void 0) {
      ...
      if (renderer.outputEncoding === sRGBEncoding6) {
        ...
        this.renderTargetLight.texture.encoding = sRGBEncoding6;
      }
    }
  }
};
...
var LookupTexture = class extends DataTexture3D {
  ...
  convertToUint8() {
    if (this.type === FloatType4) {
      ...
      this.type = UnsignedByteType11;
      this.needsUpdate = true;
    }
    return this;
  }
  convertToFloat() {
    if (this.type === UnsignedByteType11) {
...
var LUTEffect = class extends Effect {
  constructor(lut, { blendFunction = BlendFunction.NORMAL, tetrahedralInterpolation = false } = {}) {
    ...
    this.inputEncoding = sRGBEncoding8;
    this.lut = lut;
  }
  getOutputEncoding() {
  ...
  set inputEncoding(value) {
    ...
    if (lut !== null) {
      const outputEncoding = lut.encoding === LinearEncoding2 ? value : lut.encoding;
...
function getTextureDecoding(texture, isWebGL2) {
  ...
  if (texture !== null) {
    ...
    const sRGB8Alpha8 = isWebGL2 && revision >= 133 && revision !== 135 && texture.format === RGBAFormat4 && texture.type === UnsignedByteType12 && texture.encoding === sRGBEncoding9;
    if (!sRGB8Alpha8) {
