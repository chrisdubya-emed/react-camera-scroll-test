...
var POSTPROCESSING = (() => {
  ...
  var DepthComparisonMaterial = class extends import_three6.ShaderMaterial {
    constructor(depthTexture = null, camera) {
      ...
      this.depthPacking = import_three6.RGBADepthPacking;
      this.adoptCameraSettings(camera);
    }
    set depthBuffer(value) {
      this.uniforms.depthBuffer.value = value;
    ...
    setDepthBuffer(buffer, depthPacking = import_three6.RGBADepthPacking) {
      this.depthBuffer = buffer;
      this.depthPacking = depthPacking;
    }
    adoptCameraSettings(camera) {
    ...
    dispose() {
      for (const key of Object.keys(this)) {
        ...
        if (property !== null && typeof property.dispose === "function") {
          if (property instanceof import_three18.Scene || property === this.renderer) {
            continue;
          }
          this[key].dispose();
        }
  ...
  var CopyPass = class extends Pass {
    ...
    initialize(renderer, alpha, frameBufferType) {
      if (frameBufferType !== void 0) {
        ...
        } else if (renderer.outputEncoding === import_three19.sRGBEncoding) {
          this.renderTarget.texture.encoding = import_three19.sRGBEncoding;
        }
      }
    }
  };
  ...
  var Effect = class extends import_three29.EventDispatcher {
    ...
    dispose() {
      for (const key of Object.keys(this)) {
        const property = this[key];
        if (property !== null && typeof property.dispose === "function") {
          if (property instanceof import_three29.Scene || property === this.renderer) {
            continue;
          }
          this[key].dispose();
        }
...
`;
  ...
  var EffectComposer = class {
    ...
    setRenderer(renderer) {
      ...
      if (renderer !== null) {
        ...
        if (frameBufferType === import_three35.UnsignedByteType && renderer.outputEncoding === import_three35.sRGBEncoding) {
          this.inputBuffer.texture.encoding = import_three35.sRGBEncoding;
          this.outputBuffer.texture.encoding = import_three35.sRGBEncoding;
          this.inputBuffer.dispose();
          this.outputBuffer.dispose();
        }
    ...
    createBuffer(depthBuffer, stencilBuffer, type, multisampling) {
      ...
      const size = renderer === null ? new import_three35.Vector2() : renderer.getDrawingBufferSize(new import_three35.Vector2());
      const options = {
      ...
      if (type === import_three35.UnsignedByteType && renderer !== null && renderer.outputEncoding === import_three35.sRGBEncoding) {
        renderTarget.texture.encoding = import_three35.sRGBEncoding;
      }
  ...
  var BloomEffect = class extends Effect {
    ...
    initialize(renderer, alpha, frameBufferType) {
      ...
      if (frameBufferType !== void 0) {
        this.renderTarget.texture.type = frameBufferType;
        if (renderer.outputEncoding === import_three36.sRGBEncoding) {
          this.renderTarget.texture.encoding = import_three36.sRGBEncoding;
        }
      }
    }
  };
  ...
  var DepthOfFieldEffect = class extends Effect {
    ...
    initialize(renderer, alpha, frameBufferType) {
      ...
      if (frameBufferType !== void 0) {
        ...
        if (renderer.outputEncoding === import_three41.sRGBEncoding) {
          this.renderTarget.texture.encoding = import_three41.sRGBEncoding;
          this.renderTargetNear.texture.encoding = import_three41.sRGBEncoding;
          this.renderTargetFar.texture.encoding = import_three41.sRGBEncoding;
          this.renderTargetMasked.texture.encoding = import_three41.sRGBEncoding;
        }
      }
    }
  };
  ...
  var GlitchEffect = class extends Effect {
    constructor({
      ...
      if (perturbationMap === null) {
        const map = new NoiseTexture(dtSize, dtSize, import_three45.RGBAFormat);
        map.name = textureTag;
  ...
  var GodRaysEffect = class extends Effect {
    constructor(camera, lightSource, {
      ...
      this.renderPassLight.clearPass.overrideClearColor = new import_three46.Color(0);
    ...
    initialize(renderer, alpha, frameBufferType) {
      ...
      if (frameBufferType !== void 0) {
        ...
        if (renderer.outputEncoding === import_three46.sRGBEncoding) {
          this.renderTargetA.texture.encoding = import_three46.sRGBEncoding;
          this.renderTargetB.texture.encoding = import_three46.sRGBEncoding;
          this.renderTargetLight.texture.encoding = import_three46.sRGBEncoding;
        }
      }
    }
  };
  ...
  var LookupTexture = class extends import_three49.DataTexture3D {
  ...
  var LUTEffect = class extends Effect {
    ...
    set inputEncoding(value) {
      ...
      if (lut !== null) {
        const outputEncoding = lut.encoding === import_three50.LinearEncoding ? value : lut.encoding;
    ...
    set lut(value) {
      ...
      if (this.lut !== value) {
        ...
        if (value !== null) {
          ...
          if (value.type === import_three50.FloatType || value.type === import_three50.HalfFloatType) {
            defines.set("LUT_PRECISION_HIGH", "1");
          }
          if (image.width > image.height) {
            defines.set("LUT_STRIP_HORIZONTAL", "1");
          } else if (value instanceof import_three50.DataTexture3D) {
    ...
    updateScaleOffset() {
      ...
      if (lut !== null) {
        ...
        if (this.tetrahedralInterpolation && lut instanceof import_three50.DataTexture3D) {
